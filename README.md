...
Make sure to replace `DISTRO` with one of  `jammy`, `noble`, `resolute`, `bookworm` or `trixie`
...
NOTE: On systems using `dracut`, you may also need to install `openzfs-zfs-dracut`.
